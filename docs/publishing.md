...
| **CDN** | People who want it without a build step | `https://cdn.jsdelivr.net/npm/esp-flashjs@1.1.0/dist/esp-flashjs.min.js` |
...
```html
<script type="module">
  import { parseNvs } from 'https://cdn.jsdelivr.net/npm/esp-flashjs@1.1.0/src/format/nvs/parse.js';
</script>
```
